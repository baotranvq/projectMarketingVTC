...
<body>
    <div>
        <footer id="Footer" style="background-color:#fff; color:#051F4D" class="page-footer font-small stylish-color-dark pt-4">
            <div style="background-color:#fff;" class="container text-center text-md-left">
                <div class="row">
                    <div class="col-md-4 mx-auto">
                        <!-- Content -->
                        <h5 class="text-uppercase font-weight-bold mt-3 mb-4">HỌC VIỆN CÔNG NGHỆ THÔNG TIN VÀ THIẾT KẾ VTC (VTC ACADEMY)</h5>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" >
                        ...
                        <p>
                            <i class="fas fa-phone mr-3"></i> Hotline: 0865 098 399
                        </p>
                        <p>
